    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class=""> 
                ...
                <a class="navbar-brand" href="/HospitalWeb/Sinicio" id="titulo">Hospital Web</a>
            </div>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/HospitalWeb/SUsuario?accion=perfil">Ver Perfil <span class="glyphicon glyphicon-user"></span></a></li>
