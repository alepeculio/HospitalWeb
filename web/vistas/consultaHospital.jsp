            ...
            <div id="div2">
                <table class="Tvacuna">                   
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td id="vacuna"  onClick="verificar('Pentavalente-m-15')" value="Pentavalente-m-15" title="Ir a registrar"></td>
                        <td style="border-right-color: #d43f3a"></td>
                        <td ></td>
                        <td></td>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        ...
                        <p>Si desea registrar a un hijo debe dirigirse algun hospital que utiliza los servicios de Hospital Web.</p>
                        <h4>Si lo desea puede ver la ubicacion de los hospitales que utilizan nuestro servicio desde el mapa</h4><a href="SUsuario?accion=mapaUsuario&nombreH=<%=h.getNombre()%>" > Ver En Mapa</a></h5>
                    </div>
        ...
        <div class="modal fade" id="noEdad" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        <p>Usted no tiene ningun hijo registrado con la edad adecuada para reservar turno de esta vacuna.</p>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-default" data-dismiss="modal" name="aceptar" >Salir</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="form-group">
                            <label for="listaDeshabilitada">Hijo para vacunar</label><span id="spanHijo" style="color:red; visibility: hidden ">(Debe seleccionar un hijo)</span>
                            <select class="form-control" id="hijos" required >
                                
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="listaDeshabilitada">Medico</label><span id="spanMedico" style="color:red; visibility: hidden ">(Debe seleccionar un medico)</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" style="text-align: center;">
                            <strong>Seleccione un fecha en el calendario para ver sus horarios.</strong><br>
                            <span id="spanFecha" style="color:red; visibility: hidden ">(Debe seleccionar una fecha)</span>
                        </div>
                        <br>
                        ...
                        <div class="row" style="text-align: center;">
                            ...
                            <span id="spanHorario" style="color:red; visibility: hidden ">(Debe seleccionar un horario)</span>  
                        </div>
        ...
        <div class="modal fade" id="finDos" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body ">
                        <h3>Usted ya reservo un turno de vacunacion para este dia.</h3>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-default" data-dismiss="modal" name="aceptar" >Salir</button>
                    </div>
