        ...
        <div class="container bootstrap snippet panel">
            ...
            <div class="row">
                <div class="col-sm-3"><!--left col-->
                    ...
                    <ul class="list-group">
                        <li class="list-group-item text-right"><span class="pull-left"><strong>Alergia</strong></span> <button>edit</button><div class="expandable form-group text-center" style="margin-top:30px; width:100%" data-count="1">
                                <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                        <li class="active"><a href="#home" data-toggle="tab">Ultimo Tratamiento</a></li>
                        <li><a href="#messages" data-toggle="tab">Turnos reservados</a></li>
                        <li><a href="#settings" data-toggle="tab">Modificar usuario</a></li>
                    </ul>
